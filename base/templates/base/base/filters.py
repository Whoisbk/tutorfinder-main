...
class TutorFilter(django_filters.FilterSet):
    ...
    loc = django_filters.CharFilter(field_name ='location',lookup_expr='icontains' ,label='location')
    class Meta:
        model = Tutors
        fields = '__all__'
        exclude = ['user','location','subject','id_num','phone_num','img','date_created','types','fee_field','serv_desc','Experiance','qualification','facebook_link','linkedin_link','instagram_link','gender']
